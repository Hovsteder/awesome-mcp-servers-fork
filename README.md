...
- <img src="https://merx.exchange/favicon-32x32.png" height="14"/> [MERX](https://github.com/Hovsteder/merx-mcp) - TRON resource exchange for AI agents. 52 tools for energy trading, token transfers, DEX swaps, and on-chain queries across all TRON energy providers.
