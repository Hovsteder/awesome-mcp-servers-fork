...
- <img src="https://merx.exchange/favicon.ico" height="14"/> [MERX](https://github.com/Hovsteder/merx-mcp) - TRON resource exchange aggregating all energy and bandwidth providers. 52 tools for AI agents: resource-aware transactions, SunSwap DEX swaps, x402 pay-per-use, standing orders. Hosted SSE at merx.exchange/mcp/sse.
